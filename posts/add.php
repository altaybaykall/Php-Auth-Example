...
include "../session_control.php";
 ?> 
	<head>
	 ...
	 <body>	
	 <form action="kaydet.php?i=yeniKayit" method="post">
		<div class="row" style="width:400px;margin: 20px auto">
			...
			<div class="col-12" style="padding-bottom:20px">
				...
				<textarea class="form-control" required name="description" row="7"></textarea>    
			</div>
			<div class="col-4">
				Kategori : 
			</div>
				...
				<select name="category_id" required class="form-control">
					...
					if($result->num_rows>0){
						while($rs = $result->fetch_object()){
							echo '<option value="'.$rs->category_id.'">'.$rs->title.'</option>';
